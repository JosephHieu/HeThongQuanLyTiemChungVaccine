package com.josephhieu.vaccinebackend.entity.id;
...
/**
 * Lớp ID Phức hợp (Composite Primary Key) cho Entity {@link com.josephhieu.vaccinebackend.entity.ChiTietPhanQuyen}.
